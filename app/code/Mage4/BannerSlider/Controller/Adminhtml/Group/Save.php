...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Mage4\BannerSlider\Model\Group')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Mage4_BannerSlider::group_update') || $this->_authorization->isAllowed('Mage4_BannerSlider::group_create');
    }
}
